...
const renderManager = manager => {
  ...
  template = replacePlaceholders(template, "role", manager.position);
...
const renderEngineer = engineer => {
  ...
  template = replacePlaceholders(template, "role", engineer.position);
...
const renderIntern = intern => {
  ...
  template = replacePlaceholders(template, "role", intern.position);
